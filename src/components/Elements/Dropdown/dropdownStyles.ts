export const DROPDOWN_STYLE = {
  base: 'h-12 hover:cursor-pointer text-sm px-4 w-full flex justify-between items-center border rounded-md',
  baseSmall: 'h-8 hover:cursor-pointer text-sm px-2 flex justify-between items-center border  rounded-md',
...
export const DROPDOWN_POPUP_STYLE = {
  base: 'absolute mt-1 w-full bg-white dark:text-dark-900  border  shadow-lg z-30  rounded-md',
