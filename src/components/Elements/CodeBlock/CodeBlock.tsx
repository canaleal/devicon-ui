...
export const CodeBlock = ({ code, children }: CodeBlockProps) => {
  ...
  return (
    <div
      className={`flex flex-col border-2 dark:border-dark-500  rounded-lg overflow-hidden h-fit`}
    >
      <div className="flex flex-row bg-dark-600 justify-between border-b  border-dark-500">
        ...
        <Tooltip content="Copy Code" position="bottom" flashMessage="Copied!">
          <button
            ...
            className="px-4 py-3 hover:text-primary-600 text-white flex ml-auto"
          >
