...
export const IconModal = ({ icon, deviconBranch }: IconModalProps) => {
  const [selectedVersion, setSelectedVersion] = useState<IconVersion>(
    icon.versions.svg[0],
  );
  const [selectedIconSize, setSelectedIconSize] =
    useState<IIconSize>(INIT_ICON_SIZE);
      ...
      <div className="flex flex-row dark:text-white">
        <Tooltip content="Copy Icon" position="bottom" flashMessage="Copied!">
          <button
            ...
            className="p-2 hover:text-primary-600 flex "
          >
