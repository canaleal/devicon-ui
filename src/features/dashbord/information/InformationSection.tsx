...
const InformationSection = () => {
  return (
    <section className='bg-dark-900 border-b border-gray-600/20'>
      <div className='base-container base-container--lg flex-col'>
        <div className='flex flex-col gap-4 justify-center items-center text-center mb-12'>
          ...
          <p className='text-gray-400 max-w-2xl items-center '>
